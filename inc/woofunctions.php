<?php 
if(!function_exists('bella_add_customer_login_text')){
    ...
    function bella_add_customer_login_text(){
        ...
        if($text) {
            echo '<div class="logintoptxt">' . $text . '</div>';
        }
       
    }
};

if(!function_exists('bella_add_customer_register_text')){
    add_action('woocommerce_register_form_start','bella_add_customer_register_text',0);
    function bella_add_customer_register_text(){
        $text = get_field('register_text','option');
        if($text) {
            echo '<div class="logintoptxt">' . $text . '</div>';
        }
    }
...
// function woo_custom_product_info() { 
//     echo '<p>This is my custom action function</p>';
// };     
// add_action( 'woocommerce_single_product_summary', 'woo_custom_product_info', 10 ); 
